...
import com.amit.webstore.dto.CartItemDto;
...
public class CartRepositoryImpl implements CartRepository {
	...
	private static final Logger LOGGER =Logger.getLogger(CartRepositoryImpl.class);
	@Autowired 
    ...
    public void create(CartDto cartDto) { 
       ...
       System.out.println("Inside Create method of repository Impl class. QUery parsed successfully.");
       Map<String, Object> cartParams = new  
 HashMap<String, Object>(); 
cartParams.put("id", cartDto.getId());
System.out.println("Data Put inside Map. First Item Product ID: "+cartDto.getCartItems().get(0).getProductId()); 
     
       int i=jdbcTempleate.update(INSERT_CART_SQL,  
 cartParams);
       System.out.println("Value returned from update Method: "+i);
 ...
 productService.getProductById 
  (cartItemDto.getProductId()); 
   ...
   public Cart read(String id) { 
     ...
     System.out.println("ID passed from requestParameter: "+id );
      Map<String, Object> params = new HashMap<String, Object>(); 
       params.put("id", id);   
       CartMapper cartMapper = new CartMapper(jdbcTempleate, productService); 
       System.out.println("ID added as parameter: "+id);
       try { 
